package com.diagnosis_gateway.gateway.databaseConfiguration;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.diagnosis_gateway.gateway.Repository"}
)
public class DiagnosisServiceDB{
    ...
    entityManagerFactory(
        ...
        return builder
                ...
                .packages("com.diagnosis_gateway.gateway.model")
                .persistenceUnit("Diabetes")
